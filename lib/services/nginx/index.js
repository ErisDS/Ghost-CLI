...
class NginxService extends BaseService {
    ...
    setup(context) {
        ...
        function handleAnswers(answers) {
            this.ui.log('SSL: ' + answers.ssl +  ' email: ' + answers.email, 'yellow');
        ...
        if (this.config.values.ssl && this.config.values.ssl.email) {
            ...
            this.ui.log('Attempting to configure ssl', 'yellow');

            return (answers) => handleAnswers(answers);
        }

        return this.ui.prompt(prompts).then((answers) => handleAnswers(answers));
    }
    ...
    setupSSL(email, staging) {
        ...
        this.ui.log('SETTING UP SSL', 'yellow');
